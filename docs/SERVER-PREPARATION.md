...
- patient web: `web/patient`
- doctor panel: `web/doctor`
- admin panel: `web/admin`
- clinic owner panel: `web/clinic-owner`
...
`mobile/flutter/lib/core/config/app_config.dart`. Release mode rejects non-HTTPS
