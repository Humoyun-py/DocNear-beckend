...
Required placeholders are documented in each client `.env.example`; copy them to an ignored `.env` file and replace them locally or in deployment configuration.
