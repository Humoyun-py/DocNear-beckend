...
from .views import (TelegramAppointmentViewSet, CreateLinkCodeView, RedeemLinkView,
                    TelegramHandoffClaimView, TelegramHandoffCompleteView,
                    TelegramPhoneLinkView, TelegramOTPRequestView)
...
urlpatterns = [path("link-code/", CreateLinkCodeView.as_view()), path("link/", RedeemLinkView.as_view()),
    path("phone-link/", TelegramPhoneLinkView.as_view()), path("request-otp/", TelegramOTPRequestView.as_view()),
    path("handoff/claim/", TelegramHandoffClaimView.as_view()),
    path("handoff/complete/", TelegramHandoffCompleteView.as_view()),
